...
def get_value(agents, env, states, table, args):
    ...
    for actions in all_actions:
        ...
        # Get next value
        next_value = 0. if reward == 1. else args.discount * table[next_states[0], next_states[1]]
...
def train(agents, env, log, tb_writer, args):
    ...
    while True:
        ...
        for states in all_states:
            ...
            new_value = get_value(agents=agents, env=env, states=states, table=table, args=args)
